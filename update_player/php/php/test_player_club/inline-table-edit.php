...
$row1 = mysqli_query($con,"SELECT * FROM CLUB");
?>
<!DOCTYPE html>
<html>
<head>
...
$('#example1').Tabledit({
    ...
    columns: {
        ...
        editable: [[1, 'C_NAME'], [2, 'PREFFERED_POS']]
    },
    onDraw: function() {
        console.log('onDraw()');
    },
...
<body>
 ...
 <div class="panel panel-default">       
        ...
        <table cellpadding="0" cellspacing="0" border="0" id="example1">
            <tr><th>Id</th><th>Club NAME</th><th>Preferred Postion</th></tr>
    	<?php while($row = mysqli_fetch_assoc($row1)) {?>
    	<tr>
    		<td><?php echo $row['PLAYER_ID'];?></td>
    		<td><?php echo $row['C_NAME']; ?></td>
    		<td><?php echo $row['PREFFERED_POS']; ?></td>
    	<?php } ?>
        </table>
        </div>
    </div>
