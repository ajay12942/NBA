...
else  if($choices=='BY AVERAGE SPECIFIC PERFORMANCE'){

echo "<form action=\"php_submit_delete/delete_bysp.php\" method=\"post\">";
echo "<input id=\"input-1s\" type=\"text\" placeholder=\"SPECIFIC PERFORMANCE\" required autofocus name=\"pASP\"/>";
echo "<label for=\"input-1\">";
echo "<span class=\"label-text\">AVERAGE SPECIFIC PERFORMANCE</span>";
echo "<span class=\"nav-dot\"></span>";
echo "</label>";
echo "<button type=\"submit\" onclick=\"php_submit_delete/delete_bysp.php\" class=\"signup-button\">DELETE</button>";
echo "<p class=\"tip\">Press Tab</p>";
//    echo "<div class=\"signup-button\">INSERT</div>";
echo "</form>";
...
else  if($choices=='BY AVERAGE GENERAL PERFORMANCE'){

    echo "<form action=\"php_submit_delete/delete_bygp.php\" method=\"post\">";
    echo "<input id=\"input-1s\" type=\"text\" placeholder=\"GENERAL PERFORMANCE\" required autofocus name=\"pAGP\"/>";
    echo "<label for=\"input-1\">";
    echo "<span class=\"label-text\">AVERAGE GENERAL PERFORMANCE</span>";
    echo "<span class=\"nav-dot\"></span>";
    echo "</label>";
    echo "<button type=\"submit\" onclick=\"php_submit_delete/delete_bygp.php\" class=\"signup-button\">DELETE</button>";
    echo "<p class=\"tip\">Press Tab</p>";
    //    echo "<div class=\"signup-button\">INSERT</div>";
    echo "</form>";
