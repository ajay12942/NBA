...
$row1 = mysqli_query($con,"SELECT * FROM P_POSITION");
?>
<!DOCTYPE html>
<html>
<head>
...
$('#example1').Tabledit({
    ...
    columns: {
        ...
        editable: [[1, 'POINT_GUARD'], [2, 'SHOOTING_GUARD'],[3, 'POST'],[4, 'SMALL_FORWARD'],[5, 'POWER_FORWARD']]
    },
    onDraw: function() {
        console.log('onDraw()');
    },
  ...
  <li><a href="../../../../about/about.html">About</a></li>
    ...
    <div class="panel panel-default">       
    	...
    	<tr>
    		...
    		<td><?php echo $row['POINT_GUARD']; ?></td>
    		<td><?php echo $row['SHOOTING_GUARD']; ?></td>
            <td><?php echo $row['POST']; ?></td>
            <td><?php echo $row['SMALL_FORWARD']; ?></td>
            <td><?php echo $row['POWER_FORWARD']; ?></td>
    	</tr>
    	<?php } ?>
        </table>
        </div>
