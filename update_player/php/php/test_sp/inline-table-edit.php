...
$row1 = mysqli_query($con,"SELECT * FROM SP");
?>
<!DOCTYPE html>
<html>
<head>
...
$('#example1').Tabledit({
    ...
    columns: {
        ...
        editable: [[1, 'DRIBBLING'], [2, 'PASSING'],[3, 'BTFW'],[4, 'INDIVIDUAL_DEFENCE'],[5, 'PSBH'], [6, 'SR']]
    },
    onDraw: function() {
        console.log('onDraw()');
    },
...
<body>
 ...
 <div class="panel panel-default">       
    	...
    	<tr>
            ...
            <td><?php echo $row['BTFW']; ?></td>
            <td><?php echo $row['INDIVIDUAL_DEFENCE']; ?></td>
            <td><?php echo $row['PSBH'];?></td>
