...
if($choices=='PLAYERS'){
header("Location:test_players/inline-table-edit.php");
}
else  if($choices=='POSITION'){
    header("Location:test_position/inline-table-edit.php");
}

else  if($choices=='SPECIFIC PERFORMANCE'){
header("Location:test_sp/inline-table-edit.php");
}

else  if($choices=='GENERAL PERFORMANCE'){
header("Location:test_gp/inline-table-edit.php");
}
